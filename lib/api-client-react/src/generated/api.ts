...
export const getCreateSamedayAwbUrl = (id: number,) => {




  return `/api/orders/${id}/awb`
}

/**
 * @summary Create or retrieve the Sameday AWB for a paid order
 */
export const createSamedayAwb = async (id: number,
    createAwbInput?: CreateAwbInput, options?: RequestInit): Promise<SamedayAwb> => {

  return customFetch<SamedayAwb>(getCreateSamedayAwbUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(createAwbInput)
  }
);}
...
export const getCreateSamedayAwbMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSamedayAwb>>, TError,{id: number;data?: BodyType<CreateAwbInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createSamedayAwb>>, TError,{id: number;data?: BodyType<CreateAwbInput>}, TContext> => {

const mutationKey = ['createSamedayAwb'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createSamedayAwb>>, {id: number;data?: BodyType<CreateAwbInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  createSamedayAwb(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateSamedayAwbMutationResult = NonNullable<Awaited<ReturnType<typeof createSamedayAwb>>>
    export type CreateSamedayAwbMutationBody = BodyType<CreateAwbInput> | undefined
    export type CreateSamedayAwbMutationError = ErrorType<unknown>

    /**
 * @summary Create or retrieve the Sameday AWB for a paid order
 */
export const useCreateSamedayAwb = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSamedayAwb>>, TError,{id: number;data?: BodyType<CreateAwbInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createSamedayAwb>>,
        TError,
        {id: number;data?: BodyType<CreateAwbInput>},
        TContext
      > => {
      return useMutation(getCreateSamedayAwbMutationOptions(options));
    }

export const getListSamedayOohLocationsUrl = (params?: ListSamedayOohLocationsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/shipping/ooh-locations?${stringifiedParams}` : `/api/shipping/ooh-locations`
}

/**
 * @summary List available Sameday easybox locations
 */
export const listSamedayOohLocations = async (params?: ListSamedayOohLocationsParams, options?: RequestInit): Promise<SamedayOohList> => {

  return customFetch<SamedayOohList>(getListSamedayOohLocationsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListSamedayOohLocationsQueryKey = (params?: ListSamedayOohLocationsParams,) => {
    return [
    `/api/shipping/ooh-locations`, ...(params ? [params] : [])
    ] as const;
    }


export const getListSamedayOohLocationsQueryOptions = <TData = Awaited<ReturnType<typeof listSamedayOohLocations>>, TError = ErrorType<unknown>>(params?: ListSamedayOohLocationsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSamedayOohLocations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListSamedayOohLocationsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listSamedayOohLocations>>> = ({ signal }) => listSamedayOohLocations(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSamedayOohLocations>>, TError, TData> & { queryKey: QueryKey }
}

export type ListSamedayOohLocationsQueryResult = NonNullable<Awaited<ReturnType<typeof listSamedayOohLocations>>>
export type ListSamedayOohLocationsQueryError = ErrorType<unknown>
...
export function useListSamedayOohLocations<TData = Awaited<ReturnType<typeof listSamedayOohLocations>>, TError = ErrorType<unknown>>(
 params?: ListSamedayOohLocationsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listSamedayOohLocations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListSamedayOohLocationsQueryOptions(params,options)
...
export const toggleWishlist = async (wishlistToggle: WishlistToggle, options?: RequestInit): Promise<WishlistToggleResponse> => {
  ...
  return customFetch<WishlistToggleResponse>(getToggleWishlistUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(wishlistToggle)
  }
);}
...
export const getNetopiaReturnUrl = (params: NetopiaReturnParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/payments/netopia/return?${stringifiedParams}` : `/api/payments/netopia/return`
}

/**
 * @summary Netopia payment return page (receipt)
 */
export const netopiaReturn = async (params: NetopiaReturnParams, options?: RequestInit): Promise<string> => {

  return customFetch<string>(getNetopiaReturnUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getNetopiaReturnQueryKey = (params?: NetopiaReturnParams,) => {
    return [
    `/api/payments/netopia/return`, ...(params ? [params] : [])
    ] as const;
    }


export const getNetopiaReturnQueryOptions = <TData = Awaited<ReturnType<typeof netopiaReturn>>, TError = ErrorType<void>>(params: NetopiaReturnParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof netopiaReturn>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getNetopiaReturnQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof netopiaReturn>>> = ({ signal }) => netopiaReturn(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof netopiaReturn>>, TError, TData> & { queryKey: QueryKey }
}

export type NetopiaReturnQueryResult = NonNullable<Awaited<ReturnType<typeof netopiaReturn>>>
export type NetopiaReturnQueryError = ErrorType<void>
...
export function useNetopiaReturn<TData = Awaited<ReturnType<typeof netopiaReturn>>, TError = ErrorType<void>>(
 params: NetopiaReturnParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof netopiaReturn>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getNetopiaReturnQueryOptions(params,options)
